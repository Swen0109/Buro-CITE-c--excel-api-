...
namespace ASP_mvc_to_excel.Controllers
{
    public class GcExcelController : Controller
    {
        ...
        //public void PostStudentInfo(StudentInfoModel[] studenten)
        //{
        //    string apiUrl = "https://localhost:7158/api/GcExcel";
        ...
        //    string json = client.UploadString(apiUrl + "/exportStudentInfo", inputJson);//uploads the apiUrl + the string of the function with the student data.
        //}
